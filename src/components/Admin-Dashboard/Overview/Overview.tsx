...
const Overview = () => {
    ...
    return (
        <div className="text-white p-2">
            <h2 className="text-2xl font-semibold underline mb-3 text-accent">Overview</h2>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">

                {/* Total Tutorials */}
                <div className="bg-foreground p-5 rounded-xl shadow-md flex items-center gap-4 border border-white">
