...
const Lesson = () => {
    return (
        <div className="text-white">
            <h2 className="text-2xl underline font-bold text-foreground">Lesson Management</h2>
            <div className="grid lg:grid-cols-5 gap-6 mt-3">
                {/* All Orders Card */}
                <Link href="/admin-dashboard/all-lesson">
                    <div className="group bg-foreground border-white rounded-lg shadow-md p-5 flex flex-col items-center space-y-4 transition-transform duration-300 hover:scale-105 hover:shadow-xl h-full hover:border-primary">
                        <BookCheck
